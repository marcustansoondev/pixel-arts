...
const allItems = [...animals, ...kitchen, ...vehicles, ...electronics, ...clothing, ...vegetables, ...weather, ...buildings,
    {
        id: "crow",
        name: "Crow",
...
function renderGallery() {
    ...
    filtered.forEach(item => {
        ...
        const res = (item.group === "kitchen" || item.group === "vehicles" || item.group === "electronics" || item.group === "vegetables" || item.group === "weather" || item.group === "buildings") ? "50x50" : spriteResolution;
